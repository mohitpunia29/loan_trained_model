...
function Welcome({ history, closeModal }) {
  ...
  const [termsSelection, setTermsSelection] = useState(true);
      ...
      <div className={classnames('welcomeContainer')}>
        ...
        <FormGroup row>
          <FormControlLabel
            ...
            label='I acknowledge that I have read and agree to the above Entefy Software Evaluation Terms of Use.'
          />
        </FormGroup> */}
        <Button
          variant='contained'
