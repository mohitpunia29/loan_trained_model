...
class ShowMimiAiPlatformModal extends React.Component {
  state = {
    value: 0
  };
  closeIcon = () => {
...
ShowMimiAiPlatformModal.propTypes = {
  open      : PropTypes.bool.isRequired,
  closeModal: PropTypes.func.isRequired,
  data      : PropTypes.object
};

ShowMimiAiPlatformModal.defaultProps = {
  data: {}
};

export default ShowMimiAiPlatformModal;
